...
example:
    ...
    $ mkdir -p my-folder/projects/translator
    ...
    // use daz to find the content by different ways
    ...
    // by tags (empty content '', meaning matching all content)
    $ daz find '' --tags=js,node
    my-folder/projects/scientific-calculator -> Scientific Calculator for iOS and Android
    my-folder/projects/translator -> Multi-language translator Web-App
    // by both things (text in title and tags, 'lator', matching 'Calculator' and 'translator')
    $  daz find lator --tags=java
    my-folder/projects/scientific-calculator -> Scientific Calculator for iOS and Android
    my-folder/projects/translator -> Multi-language translator Web-App
    // requiring to see the whole folder routes with --show-full-path option
    $ daz find Web --show-full-path
    /Users/manuelbarzi/my-folder/projects/translator -> Multi-language translator Web-App
    // and more... explore the other options described in help above!
```
